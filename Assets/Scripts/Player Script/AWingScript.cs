...
public class AWingScript : MonoBehaviour
{
    public static AWingScript instance;
    public bool isAlive;
    private float speed = 5f;
    private float forwardSpeed = 3f;

    public GameObject AWing;
    public Animator AWingAnim;

    public AudioSource AWingAudioSource;
    ...
    void Awake()
    {
        ...
        isAlive = true;
        AWingAudioSource.PlayOneShot(noteClip);
    }
    ...
    private void fireLaser(){
        ...
        if(Input.GetButtonDown("Jump")){ //Fire1, Jump
            ...
            AWingAudioSource.PlayOneShot(laserClip);
    ...
    private void dropBomb(){
        Vector2 dropDirection = new Vector2(5,0);
        ...
        if(Input.GetButtonDown("Fire1")){
            ...
            AWingAudioSource.PlayOneShot(bombClip);
    ...
    void OnTriggerEnter2D(Collider2D target) {
        if(target.tag == "Enemy"){
            AWingAudioSource.PlayOneShot(hitClip);
    ...
    private void SelfDestruct(){
        AWingAnim.SetTrigger("Dead");
        AWingAudioSource.PlayOneShot(explodeClip);
        isAlive = false;
