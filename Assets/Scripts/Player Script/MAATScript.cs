...
public class MAATScript : MonoBehaviour
{
    public static MAATScript instance;
    public bool isAlive;
    private float speed = 3f;
    private float forwardSpeed = 3f;

    public GameObject MAAT;
    public Animator MAATAnim;

    public AudioSource MAATAudioSource;
    public AudioClip noteClip, laserClip, bombClip, hitClip, explodeClip;

    public GameObject laserPrefab1, bombPrefab;
    public GameObject laserHolder1, bombHolder;
    ...
    void Awake()
    {
        ...
        isAlive = true;
        MAATAudioSource.PlayOneShot(noteClip);
    }
    ...
    private void fireLaser(){
        ...
        if(Input.GetButtonDown("Jump")){ //Fire1, Jump
            ...
            MAATAudioSource.PlayOneShot(laserClip);
    ...
    private void dropBomb(){
        ...
        if(Input.GetButtonDown("Fire1")){
            ...
            MAATAudioSource.PlayOneShot(bombClip);
    ...
    void OnTriggerEnter2D(Collider2D target) {
        if(target.tag == "Enemy"){
            MAATAudioSource.PlayOneShot(hitClip);
    ...
    private void SelfDestruct(){
        MAATAnim.SetTrigger("Dead");
        MAATAudioSource.PlayOneShot(explodeClip);
        isAlive = false;
